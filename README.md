...
Crée un nouveau dépôt GitHub, par exemple hiit-app (public).
Ajoute le fichier index.html à la racine du dépôt (glisser-déposer via Add file → Upload files, ou git push).
Va dans Settings → Pages.
Sous Build and deployment, choisis Source : Deploy from a branch, puis Branch : main / (root), et sauvegarde.
Après environ une minute, l'URL du site apparaît en haut de la page Pages.
